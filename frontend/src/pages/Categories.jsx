...
function Categories() {
  // GENERATE BOOKS WITH DIFFERENT PDF LINKS
  const generateBooks = (count, categoryName, image, pdfs) => {
    return Array.from({ length: count }, (_, index) => ({
      title: `${categoryName} Book ${index + 1}`,
      author: `${categoryName} Author ${index + 1}`,
      image: image,
      pdf: pdfs[index % pdfs.length],
    }));
  };
  ...
  const historyPDFs = sciencePDFs;

  const selfHelpPDFs = financePDFs;
  ...
  const openBook = (pdf) => window.open(pdf, "_blank");
      ...
      >
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-xl text-gray-700">
            Explore books based on your favorite categories
          </p>
        </div>
              ...
              <div className="flex flex-col lg:flex-row gap-10">
                ...
                <div>
                  ...
                  <div className="bg-purple-100 text-purple-700 inline-block px-6 py-3 rounded-2xl text-xl font-bold">
                    Total Books: {selectedCategory.books}
                  </div>
                ...
                {showBooks && (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                      {selectedCategory.bookList.map((book, index) => (
                        <motion.div
                          key={index}
                          whileHover={{ scale: 1.05 }}
